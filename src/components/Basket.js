          ...
          <ul>
            {cartItems.map((item) => (
              <li key={item.id}>
                ...
                <span className="mx-2">{util.formatCurrency(item.price)}</span>
                <button
                  className="btn btn-info btn-sm ms-5 me-2"
                  onClick={(e) => props.decreaseFromCart(props.cartItems, item)}
                >
                  -
                </button>
                ...
                <button
                  ...
                  onClick={(e) => props.increaseFromCart(props.cartItems, item)}
                >
                  +
                </button>
                <hr />
